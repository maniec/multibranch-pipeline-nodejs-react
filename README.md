# multibranch-pipeline-nodejs-react
...
## Branching
Within the root directory (i.e. your local clone of the sample repository):
...
which should give you:
    ...
    * master
    production
If the asterisk (indicating the current branch) does not appear next to master, run following command to ensure that master is the current branch.
